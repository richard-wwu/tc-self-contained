...
__isl_give isl_id *isl_pw_qpolynomial_get_range_tuple_id(
	__isl_keep isl_pw_qpolynomial *pwqp);
...
__isl_give isl_id *isl_pw_qpolynomial_fold_get_range_tuple_id(
	__isl_keep isl_pw_qpolynomial_fold *pwf);
...
isl_bool isl_union_pw_qpolynomial_involves_param_id(
	__isl_keep isl_union_pw_qpolynomial *upwqp, __isl_keep isl_id *id);
...
__isl_give isl_pw_qpolynomial *isl_union_pw_qpolynomial_extract_on_domain_space(
	__isl_keep isl_union_pw_qpolynomial *upwqp,
	__isl_take isl_space *space);
...
isl_bool isl_union_pw_qpolynomial_fold_involves_param_id(
	__isl_keep isl_union_pw_qpolynomial_fold *upwf, __isl_keep isl_id *id);
...
isl_union_pw_qpolynomial_fold_extract_on_domain_space(
	__isl_keep isl_union_pw_qpolynomial_fold *upwf,
	__isl_take isl_space *space);
